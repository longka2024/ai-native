...
const state = {
  ...
  injectedSamples: null,
  videoScript: null,
  videoScriptStatus: "idle",
  videoScriptMessage: "",
  optimizeDiff: null,
  referenceImages: [],
...
function compactSnapshot() {
  return {
    ...
    videoTier: state.videoTier,
    ttsVoice: state.ttsVoice,
    oralVideoStatus: state.oralVideoStatus === "loading" ? "idle" : state.oralVideoStatus,
    oralVideoMessage: state.oralVideoStatus === "loading" ? "" : state.oralVideoMessage,
    oralVideoUrl: state.oralVideoUrl,
