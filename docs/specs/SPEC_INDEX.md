...
### 视觉/封面引擎（2026-06-17，补已做 + 人像对标封面）

- 文件：`docs/specs/2026-06-17-visual-cover-engine-spec.md`
- 触发说法：
  - "视觉引擎 / 封面引擎"
  - "按封面 spec"
  - "Kie 出图"
  ...
  - "内容驱动封面"
- 开发边界：
  - 出图主力切 Kie gpt-image-2；内容驱动独立封面 cover-from-content（诚实钩子 + 真实拍摄感 + 无脸）。
  - 账号默认风格锁（归藏暖金不乱跳）+ 风格路由修复；per-platform 画幅（小红书 3:4 / 公众号 3:2 / 朋友圈 1:1）。
